...
export function Modal({
  ...
  return (
    <AnimatePresence>
      {open && (
        <motion.div
          className="fixed inset-0 z-50 flex items-center justify-center bg-[#02040a]/70 p-4 backdrop-blur-[6px]"
        ...
        >
          <motion.div
            ...
            aria-label={title}
            tabIndex={-1}
            className={`glass-panel-bright hud-topline max-h-[90vh] w-[90%] overflow-y-auto rounded-modal p-8 shadow-xl focus:outline-none ${
